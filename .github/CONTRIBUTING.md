...
1. Document page must have `meta` field. refer to [here](https://github.com/geist-org/geistclone/blame/master/pages/en-us/components/avatar.mdx#L4).
...
- Create new issue to tell us: [create issue](https://github.com/geist-org/geistclone/issues/new/choose).
- Ask on [GitHub Discussions](https://github.com/geist-org/geistclone/discussions).
