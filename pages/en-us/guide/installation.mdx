...
<Tabs initialValue="yarn" hideDivider hideBorder align="flex-end" mt="-46px">
  <Tabs.Item label="Yarn" value="yarn">
    <Snippet>yarn add @geistclone/core</Snippet>
  </Tabs.Item>
  <Tabs.Item label="Npm" value="npm">
    <Snippet>npm i @geistclone/core</Snippet>
  </Tabs.Item>
</Tabs>
<Spacer h={0.5} />
<h4>
...
```jsx
import { Button, Page, Text } from '@geistclone/core'
...
In addition, we have provided a complete [Next.js application](https://github.com/geist-org/geistclone/blob/master/examples/create-next-app/README.md) example for reference.
