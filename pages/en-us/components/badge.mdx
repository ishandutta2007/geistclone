...
<>
  ...
  <Badge.Anchor>
    ...
    <Link target="_blank" href="https://github.com/geist-org/geistclone/">Geist UI</Link>
  </Badge.Anchor>
  <Spacer inline w={2.5} />
  <Badge.Anchor>
    <Badge type="error" dot padding="5px" />
    <Link target="_blank" href="https://github.com/geist-org/geistclone/">Share Link</Link>
  </Badge.Anchor>
</>
`}
/>
