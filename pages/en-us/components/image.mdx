...
<Image width="280px" height="160px"
  src="http://www.deelay.me/2000/https://geistclone.dev/images/geist-banner.png" />
`}
/>
...
<Playground
  ...
  code={`
<Image.Browser url="https://geistclone.dev/en-us/guide/introduction" anchorProps={{ rel: 'nofollow' }}>
...
<Playground
  ...
  scope={{ Image, Display, Code }}
  code={`
<Image.Browser url="https://geistclone.dev/en-us/guide/introduction" invert>
