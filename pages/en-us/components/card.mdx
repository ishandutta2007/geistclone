...
<Grid.Container gap={1.5}>
  <Grid xs={12} justify="center">
    <Card width="100%">
      ...
      <Card.Footer>
        <Link color target="_blank" href="https://github.com/geist-org/geistclone">Visit source code on GitHub.</Link>
      </Card.Footer>
    </Card>
  </Grid>
  <Grid xs={12} justify="center">
    <Card width="100%" type="dark">
      ...
      <Text>Modern and minimalist React UI library.</Text>
      <Card.Footer>
        <Link target="_blank" href="https://github.com/geist-org/geistclone">Visit source code on GitHub.</Link>
      </Card.Footer>
    </Card>
  </Grid>
</Grid.Container>
...
<Card width="400px">
  ...
  <Card.Footer>
    <Link block target="_blank" href="https://github.com/geist-org/geistclone">Visit source code on GitHub.</Link>
  </Card.Footer>
</Card>
`}
/>
