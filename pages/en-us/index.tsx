...
import PackageIcon from '@geistclone/icons/package'
import FeatherIcon from '@geistclone/icons/feather'
import GitHubIcon from '@geistclone/icons/github'
      ...
      <div className="layout">
        ...
        <Grid.Container gap={2} justify="center">
          ...
          <Grid xs={24} md={8}>
            <HomeCell
              icon={<GitHubIcon />}
              url="https://github.com/geist-org/geistclone"
              title="Open Sourced"
