...
import Github from '@geistclone/icons/github'
...
<Tabs initialValue="yarn">
  <Tabs.Item label="Yarn" value="yarn">
    <Spacer h={0.6} />
    <Snippet width="400px">yarn add @geistclone/icons</Snippet>
  </Tabs.Item>
  <Tabs.Item label="npm" value="npm">
    <Spacer h={0.6} />
    <Snippet width="400px">npm i @geistclone/icons</Snippet>
  </Tabs.Item>
</Tabs>
...
<Playground
  ...
  scope={{ Github, Spacer }}
  code={`
// import * as Icon from '@geistclone/icons'
// 或是
// import { Github } from '@geistclone/icons'
// 或是引入单个
// import Github from '@geistclone/icons/github'
