  ...
  return (
    <span className={classes} {...props}>
      ...
      <style jsx>{`
        .icon {
          position: absolute;
          left: var(--geistclone-button-icon-padding);
          right: auto;
          top: 50%;
          ...
          align-items: center;
          color: var(--geistclone-button-color);
          z-index: 1;
        }

        .right {
          right: var(--geistclone-button-icon-padding);
          left: auto;
        }

        .icon :global(svg) {
          background: transparent;
          height: calc(var(--geistclone-button-height) / 2.35);
          width: calc(var(--geistclone-button-height) / 2.35);
        }
