      ...
      <button
        ...
        <style jsx>{`
          .btn {
            ...
            --geistclone-button-icon-padding: ${SCALES.pl(0.727)};
            --geistclone-button-height: ${SCALES.height(2.5)};
            --geistclone-button-color: ${color};
            --geistclone-button-bg: ${bg};
          ...
          .btn:focus {
            color: ${hover.color};
            --geistclone-button-color: ${hover.color};
