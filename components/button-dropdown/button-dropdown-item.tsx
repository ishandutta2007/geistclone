    ...
    <button className={className} onClick={clickHandler} {...props}>
      ...
      <style jsx>{`
        button {
          ...
          color: ${colors.color};
          width: 100%;
          height: var(--geistclone-dropdown-height);
          min-width: var(--geistclone-dropdown-min-width);
          padding: var(--geistclone-dropdown-padding);
          font-size: var(--geistclone-dropdown-font-size);
        }
