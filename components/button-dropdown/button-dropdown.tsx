      ...
      <div
        ...
        <style jsx>{`
          .btn-dropdown {
            ...
            --geistclone-dropdown-height: ${SCALES.height(2.5)};
            --geistclone-dropdown-min-width: ${auto ? 'min-content' : SCALES.width(10.5)};
            --geistclone-dropdown-padding: ${SCALES.pt(0)} ${paddingRight} ${SCALES.pb(0)}
              ${paddingLeft};
            --geistclone-dropdown-font-size: ${SCALES.font(0.875)};
          }
